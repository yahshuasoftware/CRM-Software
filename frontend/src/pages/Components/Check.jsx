  ...
  return (
    <div className="relative min-h-screen">
      ...
      <video
        ...
        src="https://videos.pexels.com/video-files/3141210/3141210-uhd_2560_1440_25fps.mp4" // Replace this URL with your 3D video URL
        autoPlay
        loop
        muted
      ></video>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen bg-black bg-opacity-50">
        <div className="w-full max-w-md p-6 bg-white/70 backdrop-blur-lg rounded-lg shadow-md ">
